  ...
  (() => {
    ...
    function n(t) {
      for (; t.children && t.children.length > 0; )
        n(t.children[0]), t.remove(t.children[0]);
    ...
    a.VantaBase = class {
      constructor(t = {}) {
        ...
        if (
          ...
          this.el && (this.el.style.backgroundColor = "#0x23153c"),
          null == this.el)
        )
          ...
          if (((this.el = ((i = t), document.querySelector(i))), !this.el))
            return void l("Cannot find element", t);
        }
        var i, s;
    ...
    class d extends c {
      ...
      onInit() {
        ...
        (this.linesMesh = new p.LineSegments(a, l)),
        ...
        for (let i = 0; i <= t; i++)
          for (let o = 0; o <= t; o++) {
            ...
            let h = (o - t / 2) * e + s(-5, 5);
            i % 2 && (h += 0.5 * e),
              this.genPoint(r, n - s(5, 15), h),
              this.genPoint(r + s(-5, 5), n + s(5, 15), h + s(-5, 5));
          }
      ...
      onMouseMove(t, e) {
        const i = this.camera;
        i.oy ||
          ((i.oy = i.position.y), (i.ox = i.position.x), (i.oz = i.position.z));
